...
public class Checker {
    ...
    Checker(String file, int fileNo) throws Exception{
        lines.clear();
        if(file == "Sample"){
            FileReader FR = new FileReader("Samples/Normal Samples/SampleCases/output" + fileNo + ".txt");
            ...
            FileReader FR = new FileReader("Samples/Normal Samples/MediumCases/OLOutput.txt");
            BufferedReader BR = new BufferedReader(FR);
            String s;
            int i = 0;
            do{
            ...
            FileReader FR = new FileReader("Samples/Normal Samples/LargeCases/SFOutput.txt");
            BufferedReader BR = new BufferedReader(FR);
            String s;
            int i = 0;
            do{
    ...
    public void WriteOutFiles(String filePath, Vector<String> v, ListView<String> timeL, String txt)
    {
         try{
