...
public class Controller {
    ...
    public void runSampleCase(int fileNo)throws Exception
    {
        ...
        FileReader FR = new FileReader("Samples/Normal Samples/SampleCases/map" + fileNo + ".txt");
        FileReader FR2 = new FileReader("Samples/Normal Samples/SampleCases/queries" + fileNo + ".txt");
    ...
    public void runMediumCases()throws Exception
    {
        ...
        timeList.getItems().clear();
        resultslist.getItems().clear();
        FileReader FR = new FileReader("Samples/Normal Samples/MediumCases/OLMap.txt");
        FileReader FR2 = new FileReader("Samples/Normal Samples/MediumCases/OLQueries.txt");
        DoubleEndDjikestra DEJ = new DoubleEndDjikestra();
        DEJ.build(FR);
        DEJ.lines.clear();
        DEJ.timeL.getItems().clear();
    ...
    public void runLargeCases()throws Exception
    {
        ...
        timeList.getItems().clear();
        resultslist.getItems().clear();
        FileReader FR = new FileReader("Samples/Normal Samples/LargeCases/SFMap.txt");
        FileReader FR2 = new FileReader("Samples/Normal Samples/LargeCases/SFQueries.txt");
        DoubleEndDjikestra DEJ = new DoubleEndDjikestra();
        DEJ.build(FR);
        DEJ.lines.clear();
        DEJ.timeL.getItems().clear();
